...
static const chrono::milliseconds delayDelta =
...
class CliFlavour {
 ...
 public:
  ...
  /*
 * If supplied command is command to show running config or other command where caching is supported,
 * return index where the base command ends.
