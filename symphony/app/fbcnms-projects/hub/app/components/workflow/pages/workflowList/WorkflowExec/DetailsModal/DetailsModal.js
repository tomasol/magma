...
class DetailsModal extends Component {
  ...
  executeWorkflow() {
    ...
    http
      .post(
        conductorApiUrlPrefix + '/workflow',
  ...
  terminateWfs() {
    http
      .delete(conductorApiUrlPrefix + '/bulk/terminate', [this.state.wfId])
      .then(() => {
        this.getData();
      });
  }
  ...
  pauseWfs() {
    http
      .put(conductorApiUrlPrefix + '/bulk/pause', [this.state.wfId])
      .then(() => {
        this.getData();
      });
  }
  ...
  resumeWfs() {
    http
      .put(conductorApiUrlPrefix + '/bulk/resume', [this.state.wfId])
      .then(() => {
        this.getData();
      });
  }
  ...
  retryWfs() {
    http
      .post(conductorApiUrlPrefix + '/bulk/retry', [this.state.wfId])
      .then(() => {
        this.getData();
      });
  }
  ...
  restartWfs() {
    http
      .post(conductorApiUrlPrefix + '/bulk/restart', [this.state.wfId])
      .then(() => {
        this.getData();
      });
  }
